...
if [ ! -f "/home/admin/first_run" ]
then    
    mysql -uroot -e "CREATE DATABASE IF NOT EXISTS kylin4 default charset utf8 COLLATE utf8_general_ci;"
    mysql -uroot -e "grant all privileges on root.* to root@'%' identified by '123456';FLUSH   PRIVILEGES;"
fi
